...
![Simple flowchart with directional arrows from web server to user directly and vice versa](/assets/images/image-7.png)
...
![An advertisement example on a website](/assets/images/Screenshot-2024-07-06-190956.png)



![An advertisement example on a website](/assets/images/Screenshot-2024-07-06-191827.png)

_Sites with "free software downloads" are the best ones to demonstrate online ads..._
...
![Screenshot of AdGuard Home dashboard](/assets/images/image-9.png)

_AdGuard Home WebUI... More on that in a moment_
...
![Graph explaining DNS in a typical home network setup, demonstrating what it takes to access google.com starting from DHCP](/assets/images/image-8.png)

_Just a simplified example! Google has a ton of addresses..._
...
![A diagram showing how normal websites and ad websites are handled differently by AdGuard home](/assets/images/image-10.png)

_Probably not a real conversation..._
...
![A list of blocklists available to install with one-click on AGH WebUI](/assets/images/image-11.png)

![A prompt where a custom blocklist can be supplied with an URL](/assets/images/image-12.png)
...
![AGH WebUI for configuring DNS rewrites](/assets/images/image-13.png)
...
![Settings for the custom DHCP server in AGH](/assets/images/image-14.png)
...
![Upstream DNS settings in AGH, with four entries of Cloudflare DNS](/assets/images/image-15.png)
...
![Diagram showing how ads from the same hostname can't be blocked](/assets/images/image-16.png)
